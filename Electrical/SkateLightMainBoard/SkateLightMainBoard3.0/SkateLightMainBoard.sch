...
F 2 "LolomoloKiCADLib:ThermalPadV2_SkateLight" H 8550 1500 50  0001 C CNN
...
F 2 "LolomoloKiCADLib:ThermalPadV2_SkateLight" H 8350 1750 50  0001 C CNN
...
U 1 1 5DF97493
P 8350 1950
F 0 "#PWR032" H 8350 1700 50  0001 C CNN
...
U 1 1 5DFA9A56
P 8550 1700
F 0 "#PWR033" H 8550 1450 50  0001 C CNN
...
U 1 1 5DACCD26
P 9550 5000
F 0 "J4" H 9600 5517 50  0000 C CNN
...
F 1 "+3V3" H 7865 2923 50  0000 C CNN
...
U 1 1 5E0A6B83
P 2650 2250
F 0 "#PWR06" H 2650 2100 50  0001 C CNN
...
U 1 1 5DE8DC8E
P 3600 4950
F 0 "#PWR015" H 3600 4800 50  0001 C CNN
...
F9 "SYNC" I R 10350 3450 50 
F10 "LED+" I R 10350 2700 50 
F11 "LED-" I R 10350 2850 50 
$EndSheet
...
U 1 1 5E01E0BB
P 9400 2600
F 0 "#PWR034" H 9400 2450 50  0001 C CNN
...
U 1 1 5E021DB2
P 9400 3550
F 0 "#PWR035" H 9400 3300 50  0001 C CNN
...
F 1 "120" H 2120 3805 50  0000 L CNN
...
U 1 1 5E091FCB
P 4400 5400
F 0 "C3" H 4515 5446 50  0000 L CNN
F 1 "100nF" H 4515 5355 50  0000 L CNN
...
U 1 1 5E0932E2
P 4400 5650
F 0 "#PWR017" H 4400 5400 50  0001 C CNN
...
F 1 "100nF" H 3865 3555 50  0000 L CNN
...
U 1 1 5E27FDE2
P 1850 1750
F 0 "#FLG0101" H 1850 1825 50  0001 C CNN
...
U 1 1 5E285CFF
P 1850 1650
F 0 "#PWR0104" H 1850 1500 50  0001 C CNN
...
U 1 1 5E295930
P 2150 1650
F 0 "#FLG0102" H 2150 1725 50  0001 C CNN
...
U 1 1 5E295EAD
P 2450 1750
F 0 "#FLG0103" H 2450 1825 50  0001 C CNN
...
U 1 1 5E24B06D
P 9550 5300
F 0 "#PWR0103" H 9550 5050 50  0001 C CNN
...
U 1 1 5DB71BCD
P 9250 5300
F 0 "#PWR037" H 9250 5150 50  0001 C CNN
...
U 1 1 5E1568A0
P 7750 3550
F 0 "Q3" H 7940 3596 50  0000 L CNN
F 1 "Q_Photo_NPN" H 7940 3505 50  0000 L CNN
F 2 "Diode_SMD:D_0603_1608Metric" H 7950 3650 50  0001 C CNN
...
F12 "LightSense3" I R 6550 3300 50 
F13 "Temp2" I R 6550 2950 50 
F14 "LED-" I R 6550 3600 50 
F15 "LED_CTRL" O R 6550 3700 50 
F16 "IMU_INT2" I R 6550 2700 50 
F17 "CAN_LBK" I L 5450 3300 50 
F18 "CAN_Rs" O L 5450 3400 50 
F19 "CAN_TX" O L 5450 3500 50 
F20 "CAN_RX" I L 5450 3600 50 
F21 "3V3" I L 5450 2600 50 
F22 "GND" I L 5450 3950 50 
F23 "LEDSign1" O R 6550 3850 50 
F24 "LEDSign2" O R 6550 3950 50 
$EndSheet
...
U 1 1 5EF286A8
P 5350 4050
F 0 "#PWR08" H 5350 3800 50  0001 C CNN
