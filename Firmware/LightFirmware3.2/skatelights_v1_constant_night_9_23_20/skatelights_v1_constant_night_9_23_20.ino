 ...
 * in blink_indecator() write code for buzz
 */
...
#define RED_TEST_LED PIN_PC4  //front red led
...
MCP4XXX * pot;
int pot_bright = 23; // pot value for max brightness (front light)
int pot_dim = 26;   // pot value for min brightness (front light)
